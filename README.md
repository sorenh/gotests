# gotests [![License](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](https://github.com/sorenh/gotests/blob/master/LICENSE) [![godoc](https://img.shields.io/badge/go-documentation-blue.svg)](https://godoc.org/github.com/sorenh/gotests) [![Build Status](https://travis-ci.org/sorenh/gotests.svg?branch=master)](https://travis-ci.org/sorenh/gotests) [![Coverage Status](https://coveralls.io/repos/github/sorenh/gotests/badge.svg?branch=master)](https://coveralls.io/github/sorenh/gotests?branch=master) [![codebeat badge](https://codebeat.co/badges/7ef052e3-35ff-4cab-88f9-e13393c8ab35)](https://codebeat.co/projects/github-com-sorenh-gotests) [![Go Report Card](https://goreportcard.com/badge/github.com/sorenh/gotests)](https://goreportcard.com/report/github.com/sorenh/gotests)
...
```sh
$ go get -u github.com/sorenh/gotests/...
```
